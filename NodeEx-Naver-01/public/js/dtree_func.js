...
class dTree {
  constructor(objName) {
    ...
    this.icon = {
      root: "/_HTM/images/dtree_img/base.gif",
      folder: "/_HTM/images/dtree_img/folder.gif",
      folderOpen: "/_HTM/images/dtree_img/folderopen.gif",
      node: "/_HTM/images/dtree_img/page.gif",
      empty: "/_HTM/images/dtree_img/empty.gif",
      line: "/_HTM/images/dtree_img/line.gif",
      join: "/_HTM/images/dtree_img/join.gif",
      joinBottom: "/_HTM/images/dtree_img/joinbottom.gif",
      plus: "/_HTM/images/dtree_img/plus.gif",
      plusBottom: "/_HTM/images/dtree_img/plusbottom.gif",
      minus: "/_HTM/images/dtree_img/minus.gif",
      minusBottom: "/_HTM/images/dtree_img/minusbottom.gif",
      nlPlus: "/_HTM/images/dtree_img/nolines_plus.gif",
      nlMinus: "/_HTM/images/dtree_img/nolines_minus.gif",
    };
    this.obj = objName;
    this.aNodes = [];
    this.aIndent = [];
  ...
  node(node, nodeId) {
    ...
    if (node.url) {
      ...
      if (this.config.useSelection && ((node._hc && this.config.folderLinks) || !node._hc))
        str += ' onclick="javascript: ' + this.obj + ".o(" + nodeId + ');"'; // str += ' onclick="javascript: ' + this.obj + '.s(' + nodeId + ');"';
      str += ">";
