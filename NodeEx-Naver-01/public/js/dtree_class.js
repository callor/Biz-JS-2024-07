...
class dTree {
  ...
  toString() {
    ...
    str += `<div style="text-align:center;margin:5px;"><button type="button" onclick="d.openAll();">Open All</button> <button type="button" onclick="d.closeAll();">Close All</button></div>\n`;
